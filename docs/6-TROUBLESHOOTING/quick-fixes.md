...
3. **Update regularly** — Pull latest image: `docker pull meranh05/notebooke:latest`
...
- **Ask for help:** [Discord](https://discord.gg/37XJPXfz2w) or [GitHub Issues](https://github.com/Meranh05/NotebookE/issues)
