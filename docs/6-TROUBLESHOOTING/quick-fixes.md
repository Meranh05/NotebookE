...
3. **Update regularly** — Pull latest image: `docker pull lfnovo/notebooke:latest`
...
- **Ask for help:** [Discord](https://discord.gg/37XJPXfz2w) or [GitHub Issues](https://github.com/lfnovo/notebooke/issues)
