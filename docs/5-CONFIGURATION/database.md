...
NotebookE uses SurrealDB for its database needs.

---

## Default Configuration

NotebookE should work out of the box with SurrealDB as long as the environment variables are correctly setup.

### DB running in the same docker compose as NotebookE (recommended)
...
### NotebookE and Surreal are running on the same machine
