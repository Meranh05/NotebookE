...
Before diving into how to use NotebookE, it's important to understand **how it thinks**. These core concepts explain the "why" behind the design.

## The Five Mental Models

### 1. [Notebooks, Sources, and Notes](notebooks-sources-notes.md)

How NotebookE organizes your research. Understand the three-tier container structure and how information flows from raw materials to finished insights.
...
How NotebookE makes AI aware of your research - two different approaches.
...
Why NotebookE has different interaction modes and when to use each one.
...
Why NotebookE can turn research into audio and why this matters.
...
- **You're new to NotebookE** — Start here to understand how the system works conceptually before learning the features
...
NotebookE is built on a simple insight: **Your research deserves to stay yours**.
