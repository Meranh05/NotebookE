# User Guide - How to Use NotebookE

This guide covers practical, step-by-step usage of NotebookE features. You already understand the concepts; now learn how to actually use them.
