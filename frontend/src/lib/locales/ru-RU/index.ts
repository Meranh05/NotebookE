...
export const ruRU = {
  ...
  connectionErrors: {
    ...
    apiDesc: "API-сервер NotebookE недоступен",
    ...
    docLink: "Документация NotebookE",
  ...
  chat: {
    ...
    stoppedByUser: "Вы остановили ответ.",
  },
  searchPage: {
    askAndSearch: "Запрос и поиск",
    askBeta: "Запрос (бета)",
  ...
  settings: {
    ...
    filesHelp: "После загрузки и обработки файлы больше не нужны. Большинству пользователей следует разрешить NotebookE автоматически удалять загруженные файлы из папки загрузок.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Доступна новая версия NotebookE.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Настройте, какие модели использовать для различных задач в NotebookE",
    missingRequiredModels: "Отсутствуют необходимые модели: {{models}}. NotebookE может работать некорректно без них.",
  ...
  apiKeys: {
    ...
    description: "Храните API-ключи в базе данных для безопасного подключения провайдеров ИИ в NotebookE.",
