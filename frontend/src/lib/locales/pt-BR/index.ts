...
export const ptBR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "O servidor da API do NotebookE não pôde ser alcançado",
    ...
    docLink: "Documentação do NotebookE",
  ...
  chat: {
    ...
    stoppedByUser: "Você interrompeu a resposta.",
  },
  searchPage: {
    askAndSearch: "Perguntar e Buscar",
  ...
  settings: {
    ...
    filesHelp: "Uma vez que seus arquivos são enviados e processados, eles não são mais necessários. A maioria dos usuários deve permitir que o NotebookE exclua arquivos enviados da pasta de upload automaticamente.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Uma nova versão do NotebookE está disponível.",
    upToDate: "Atualizado",
    unknown: "Desconhecido",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure quais modelos usar para diferentes propósitos no NotebookE",
    missingRequiredModels: "Modelos obrigatórios ausentes: {{models}}. O NotebookE pode não funcionar corretamente sem eles.",
  ...
  apiKeys: {
    ...
    description: "Armazene chaves de API com segurança no banco de dados para habilitar provedores de IA no NotebookE.",
