export const enUS = {
  ...
  connectionErrors: {
    ...
    apiDesc: "The NotebookE API server could not be reached",
    ...
    docLink: "NotebookE Documentation",
  ...
  chat: {
    ...
    stoppedByUser: "You stopped the response.",
  },
  searchPage: {
    askAndSearch: "Ask and Search",
    askBeta: "Ask (beta)",
  ...
  settings: {
    ...
    videoDefaultsDesc: "These settings will be used as defaults when generating videos.",
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow NotebookE to delete uploaded files from the upload folder automatically.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of NotebookE is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  models: {
    ...
    videoModelDesc: "Used for generating video scripts and narrations",
    ...
    defaultAssignmentsDesc: "Configure which models to use for different purposes across NotebookE",
    missingRequiredModels: "Missing required models: {{models}}. NotebookE may not function properly without these.",
  ...
  apiKeys: {
    ...
    description: "Store API keys securely in the database to enable AI providers in NotebookE.",
