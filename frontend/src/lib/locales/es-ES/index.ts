...
export const esES = {
  ...
  connectionErrors: {
    ...
    apiDesc: "No se pudo alcanzar el servidor API de NotebookE",
    ...
    docLink: "Documentación de NotebookE",
  ...
  chat: {
    ...
    stoppedByUser: "Has detenido la respuesta.",
  },
  searchPage: {
    askAndSearch: "Preguntar y buscar",
  ...
  settings: {
    ...
    filesHelp: "Una vez que tus archivos se suben y procesan, ya no son necesarios. La mayoría de los usuarios deberían permitir que NotebookE elimine los archivos subidos de la carpeta de carga automáticamente.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Una nueva versión de NotebookE está disponible.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configura qué modelos usar para diferentes propósitos en NotebookE",
    missingRequiredModels: "Faltan modelos requeridos: {{models}}. NotebookE puede no funcionar correctamente sin estos.",
  ...
  apiKeys: {
    ...
    description: "Almacena claves API de forma segura en la base de datos para habilitar proveedores de IA en NotebookE.",
