...
export const itIT = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Il server API di NotebookE non è raggiungibile",
    ...
    docLink: "Documentazione NotebookE",
  ...
  chat: {
    ...
    stoppedByUser: "Hai interrotto la risposta.",
  },
  searchPage: {
    askAndSearch: "Chiedi e cerca",
    askBeta: "Chiedi (beta)",
  ...
  settings: {
    ...
    filesHelp: "Una volta caricati ed elaborati, i tuoi file non sono più necessari. La maggior parte degli utenti dovrebbe permettere a NotebookE di eliminare automaticamente i file caricati dalla cartella upload.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "È disponibile una nuova versione di NotebookE.",
    upToDate: "Aggiornato",
    unknown: "Sconosciuto",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configura quali modelli usare per diversi scopi in NotebookE",
    missingRequiredModels: "Modelli richiesti mancanti: {{models}}. NotebookE potrebbe non funzionare correttamente senza questi.",
  ...
  apiKeys: {
    ...
    description: "Salva le chiavi API in modo sicuro nel database per abilitare i provider IA in NotebookE.",
