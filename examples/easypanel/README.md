...
This directory contains an EasyPanel template for NotebookE. It follows the
...
- NotebookE, exposed on port `8502`.
...
Set an NotebookE password in the form before deploying. If it is left blank,
...
NotebookE's Settings > API Keys page.
