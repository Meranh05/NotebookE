"""
Unit tests for the notebooke.utils.embedding module.
...
from notebooke.utils.chunking import CHUNK_SIZE
from notebooke.utils.embedding import (
    generate_embedding,
    generate_embeddings,
    mean_pool_embeddings,
)
from notebooke.utils.token_utils import token_count
...
class TestGenerateEmbedding:
    ...
    async def test_content_type_parameter(self):
        ...
        from notebooke.utils.chunking import ContentType
    ...
    async def test_batching(self):
        ...
        from notebooke.utils.embedding import EMBEDDING_BATCH_SIZE
    ...
    async def test_batch_retry_on_transient_failure(self):
        ...
        with (
            ...
            patch("notebooke.utils.embedding.EMBEDDING_RETRY_DELAY", 0),
        ):
            result = await generate_embeddings(texts)
    ...
    async def test_batch_retry_exhaustion(self):
        ...
        from notebooke.utils.embedding import EMBEDDING_MAX_RETRIES
...
class TestErrorClassifier413:
    ...
    def test_413_status_code(self):
        from notebooke.exceptions import ExternalServiceError
