...
from notebooke.database.repository import ensure_record_id, repo_query, repo_upsert
from notebooke.domain.base import RecordModel
from notebooke.utils.encryption import decrypt_value, encrypt_value
...
class ProviderConfig(RecordModel):
    ...
    record_id: ClassVar[str] = "notebooke:provider_configs"
    ...
    async def save(self) -> "ProviderConfig":
        ...
        await repo_upsert("notebooke", self.record_id, data)
        return self
