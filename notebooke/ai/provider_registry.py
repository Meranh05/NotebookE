...
- `notebooke/ai/connection_tester.py` `TEST_MODELS`
- `notebooke/ai/model_discovery.py` `OPENAI_COMPAT_PROVIDERS`
...
_PROVIDER_SPECS: Tuple[ProviderSpec, ...] = (
        ...
        ProviderSpec(
            ...
            docs_url="https://github.com/lfnovo/notebooke/blob/main/docs/5-CONFIGURATION/omlx.md",
        ...
        ProviderSpec(
            ...
            test_model=None,  # Dynamic - uses first available model
            docs_url="https://github.com/lfnovo/notebooke/blob/main/docs/5-CONFIGURATION/openai-compatible.md",
        ),
        ProviderSpec(
            ...
            docs_url="https://github.com/lfnovo/notebooke/blob/main/docs/5-CONFIGURATION/ai-providers.md",
