...
A flexible and generic ContextBuilder class for the NotebookE project that can handle any parameters and build context from sources, notebooks, insights, and notes.
...
```python
from notebooke.utils.context_builder import ContextBuilder, ContextConfig
...
```python
from notebooke.utils.context_builder import ContextConfig
...
```python
from notebooke.utils.context_builder import ContextItem
...
The ContextBuilder integrates seamlessly with the existing NotebookE architecture:
